...
def main():
    ...
    env = gym_snake.envs.SnakeEnv(grid_size=[11, 11], unit_size=1 , unit_gap=0, n_snakes=5, n_foods=13)
    ...
    policy =  CnnPolicy
    model = ppo2.learn(policy=policy, env=env, nsteps=2048*8, nminibatches=16, gamma=0.9, vf_coef=2.0,
