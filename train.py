...
def main():
    ...
    env = gym_snake.envs.SnakeEnv(grid_size=[9, 9], unit_size=1 , unit_gap=0, n_snakes=4, n_foods=3)
    ...
    policy =  CnnPolicy
    model = ppo2.learn(policy=policy, env=env, nsteps=2048*8, nminibatches=32, gamma=0.9,# vf_coef=2.0,
